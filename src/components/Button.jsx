...
const Button = ({ children, hovered, onMouseEnter, onMouseLeave, onClick, type, fullWidth }) => (
	<button onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave} onClick={onClick} style={calcStyle({ type, hovered, fullWidth })}>
		{children}
	</button>
)
